    ...
    return (
      <IceContainer>
        ...
        <div style={styles.content}>
          <p style={styles.desc}>
            鉴于兰州城市学院网提供的信息发布服务属于电子公告牌（BBS）性质，兰州城市学院网上的店铺、商品信息（包括但不限于店铺名称、公司名称、
            联系人及联络信息、产品的描述和说明、相关图片、视频等）由用户自行提供并上传，由用户对其提供并上传的信息承担相应法律责任
            兰州城市学院网服务提供者对此另有约定的，将在相关的协议或其他法律文本中与您进行明确。
          </p>
          <p style={styles.desc}>
            我们尊重知识产权，反对并打击侵犯知识产权的行为。知识产权权利人若认为兰州城市学院网内容（包括但不限于兰州城市学院网用户发布的商品信息）
            侵犯其合法权益的，可以通过马小楷知识产权保护平台（https://ipp.alibabagroup.com/）进行投诉，我们将在收到知识
          ...
          <p style={styles.desc}>
            ...
            我们同时对兰州城市学院网网站提供HTTPS（Hyper Text Transfer Protocol over
