export default {
  ...
  'app.menu.table': '表格页',
  'app.menu.table.basic': '订单系统',
  'app.menu.table.general': '商品管理',

  'app.menu.list': '列表页',
  'app.menu.list.basic': '订单系统',
  'app.menu.list.general': '权限管理',
  ...
  'app.header.help': '帮助',
  'app.header.user.name': '马小田',
  'app.header.user.department': '兰州城市学院',
